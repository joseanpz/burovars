...
class BuroFechaReporteModel(BaseModel):
    fech_rep: date = Schema(None, title='FECHA DE REPORTE', alias='fechRep')
    dolar: float = Schema(None, title='Valor de dolar en la fecha del reporte', alias='dolar')
    udi: float = Schema(None, title='Valor de la udi en la fecha dle reporte', alias='udi')


class BuroConsultaModel(BaseModel):
    folio: str = Schema(None, title='NÚMERO DE CUENTA CONSULTADA', alias='cofFolio')
    fecha_buro: date = Schema(None, title='FECHA DE RESPUESTA DE BURO', alias='cofFecBur')
    cof_consec: int = Schema(None, title='CONSECUTIVO, INDICE', alias='cofConsec')
    cof_fec_con: date = Schema(None, title='FECHA DE CONSULTA DE LA CUENTA', alias='cofFecCon')
    cof_cve_oto: str = Schema(None, title='CLAVE DE OTORGANTE', alias='cofCveOto')
    cof_buro_id: str = Schema(None, title="Id de buro", description="descripcion del id de buró", alias='cofBuroId')
    cof_nom_oto: str = Schema(None, title='NOMBRE DE OTORGANTE', alias='cofNomOto')
    cof_tip_con: str = Schema(None, title='TIPO DE CONTRATO', alias='cofTipCon')
    cof_cve_mon: str = Schema(None, title='MONEDA DEL CREDITO', alias='cofCveMon')
    cof_import: str = Schema(None, title='', alias='cofImport')
    cof_tip_res: str = Schema(None, title='', alias='cofTipRes')
    cof_consumo: str = Schema(None, title='', alias='cofConsum')
    cof_result: int = Schema(None, title='', alias='cofResult')
...
class BuroCuentasModel(BaseModel):
    folio: str = Schema(None, title='NÚMERO DE CUENTA CONSULTADA', alias='cufFolio')
    fecha_buro: date = Schema(None, title='FECHA DE RESPUESTA DE BURO', alias='fecFecBur')
    cuf_consec: int = Schema(None, title='FECHA DE ACTUALIZACIÓN DE LA CUENTA EN TL', alias='cufConsec')
    cuf_fec_act: date = Schema(None, title='FECHA DE ACTUALIZACIÓN DE LA CUENTA EN TL', alias='cufFecAct')
    cuf_reg_imp: str = Schema(None, title='REGISTRO IMPUGNADO', alias='cufRegImp')
    cuf_cve_oto: str = Schema(None, title='CLAVE DE OTORGANTE', alias='cufCveOto')
    cuf_nom_oto: str = Schema(None, title='NOMBRE DE OTORGANTE', alias='cufNomOto')
    cuf_num_cue: str = Schema(None, title='NUMERO DE CUENTA', alias='cufNumCue')
    cuf_tip_res: str = Schema(None, title='TIPO DE RESPONSABILIDAD', alias='cufTipRes')
    cuf_tip_cue: str = Schema(None, title='TIPO DE CUENTA', alias='cufTipCue')
    cuf_tip_con: str = Schema(None, title='TIPO DE CONTRATO', alias='cufTipCon')
    cuf_cve_mon: str = Schema(None, title='MONEDA DEL CREDITO', alias='cufCveMon')
    cuf_val_act: int = Schema(None, title='IMPORTE DEL AVALUO', alias='cufValAct')
    cuf_num_pag: int = Schema(None, title='NÚMERO DE PAGOS', alias='cufNumPag')
    cuf_fre_pag: str = Schema(None, title='FRECUENCIA DE PAGO', alias='cufFrePag')
    cuf_monto: float = Schema(None, title='MONTO A PAGAR', alias='cufMonto')
    cuf_fec_ape: date = Schema(None, title='FECHA DE APERTURA', alias='cufFecApe')
    cuf_ult_pag: date = Schema(None, title='FECHA DE ÚLTIMO PAGO', alias='cufUltPag')
    cuf_ult_com: date = Schema(None, title='FECHA DE ÚLTIMA COMPRA', alias='cufUltCom')
    cuf_fec_cie: date = Schema(None, title='FECHA DE CIERRE', alias='cufFecCie')
    cuf_fec_rep: date = Schema(None, title='FECHA DE REPORTE', alias='cufFecRep')
    cuf_fma_rep: str = Schema(None, title='MODO DE REPORTAR', alias='cufFmaRep')
    cuf_ult_sal: date = Schema(None, title='ÚLTIMA FECHA CON SALDO CERO', alias='cufUltSal')
    cuf_garant: str = Schema(None, title='GARANTÍA', alias='cufGarant')
    cuf_max_cre: float = Schema(None, title='CRÉDITO MÁXIMO AUTORIZADO', alias='cufMaxCre')
    cuf_sal_act: float = Schema(None, title='SALDO ACTUAL', alias='cufSalAct')
    cuf_lim_cre: float = Schema(None, title='LÍMITE DE CRÉDITO', alias='cufLimCre')
    cuf_sal_ven: float = Schema(None, title='SALDO VENCIDO', alias='cufSalVen')
    cuf_pag_ven: float = Schema(None, title='NÚMERO DE PAGOS VENCIDOS', alias='cufPagVen')
    cuf_fma_pag: str = Schema(None, title='CLASIFICACIÓN DE PUNTUALIDAD DE PAGO MOP', alias='cufFmaPag')
    cuf_hist_pag: str = Schema(None, title='HISTÓRICO DE PAGOS', alias='cufHisPag')
    cuf_fec_rec: date = Schema(None, title='FECHA MAS RECIENTE DEL HISTÓRICO DE PAGOS', alias='cufFecRec')
    cuf_fec_ant: date = Schema(None, title='FECHA MAS ANTIGUA DEL HISTÓRICO DE PAGOS', alias='cufFecAnt')
    cuf_cve_obs: str = Schema(None, title='CLAVE DE OBSERVACIÓN', alias='cufCveObs')
    cuf_tot_pag: int = Schema(None, title='TOTAL DE PAGOS REPORTADOS', alias='cufTotPag')
    cuf_mop_02: int = Schema(None, title='TOTAL DE PAGOS CON MOP = 02', alias='cufMop02')
    cuf_mop_03: int = Schema(None, title='TOTAL DE PAGOS CON MOP = 03', alias='cufMop03')
    cuf_mop_04: int = Schema(None, title='TOTAL DE PAGOS CON MOP = 04', alias='cufMop04')
    cuf_mop_05: int = Schema(None, title='TOTAL DE PAGOS CON MOP = 05 O MAYOR', alias='cufMop05')
    cuf_imp_sal: int = Schema(None, title='SALDO EN LA MOROSIDAD HISTÓRICA MAS ALTA', alias='cufImpSal')
    cuf_fec_mor: date = Schema(None, title='FECHA DE LA MOROSIDAD HISTÓRICA MAS ALTA', alias='cufFecMor')
    cuf_mop_mor: str = Schema(None, title='MOP EN LA MOROSIDAD MAS ALTA', alias='cufMopMor')
    cuf_reestr: date = Schema(None, title='FECHA DE INICIO DE LA REESTRUCTURA', alias='cufReestr')

    # variables economicas
    dlr_fec_rep: float = Schema(None, title='VALOR DE DOLAR EN LA FECHA DE REPORTE', alias='fecRepDol')
    udi_fec_rep: float = Schema(None, title='VALOR DEL UDI EN LA FECHA DE REPORTE', alias='fecRepUdi')
    udi_fec_ape: float = Schema(None, title='VALOR DE UDI EN LA FECHA DE APERTURA', alias='fecApeUdi')
    udi_fec_buro: float = Schema(None, title='VALOR DE UDI EN LA FECHA DE BURO', alias='fecConUdi')

    # variable de entrada
    fecha_alta: date = Schema(None, title='', alias='fecAlta')
...
class BuroScoreModel(BaseModel):
    scf_consec: int = Schema(None, title='', alias='scfConsec')
    scf_nombre: str = Schema(None, title='', alias='scfNombre')
    scf_codigo: str = Schema(None, title='', alias='scfCodigo')
    scf_valor: int = Schema(None, title='', alias='scfValor')
    scf_razon1: str = Schema(None, title='', alias='scfRazon1')
    scf_razon2: str = Schema(None, title='', alias='scfRazon2')
    scf_razon3: str = Schema(None, title='', alias='scfRazon3')
    scf_err: str = Schema(None, title='', alias='scfErr')
    scf_recal: int = Schema(1, title='', alias='scfRecal')
    scf_fraude: bool = Schema(False, title='', alias='scfFraude')
    icc_valor: int = Schema(0, title='', alias='inpICCVal')
